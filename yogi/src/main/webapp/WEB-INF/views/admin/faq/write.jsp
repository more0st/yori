						...
						<table class="table table-borderless">
		 					<tr>
								<td class="text-center">
									...
									<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/admin/faq/list';">${mode=='update'?'수정취소':'등록취소'}&nbsp;<i class="bi bi-x"></i></button>
